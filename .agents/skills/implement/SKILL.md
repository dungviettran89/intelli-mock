...
3. Read any referenced design documents (`docs/ARCHITECT.md`, `docs/PRD.md`, `docs/API.md`, `docs/DATABASE.md`)
...
11. If build or test fails after reasonable attempts, report the issue to the user and pause
